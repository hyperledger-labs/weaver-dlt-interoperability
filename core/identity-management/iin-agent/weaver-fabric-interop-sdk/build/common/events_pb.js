...
proto.common.events.EventSubscriptionState.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    eventMatcher: (f = msg.getEventMatcher()) && proto.common.events.EventMatcher.toObject(includeInstance, f),
    eventPublicationSpec: (f = msg.getEventPublicationSpec()) && proto.common.events.EventPublication.toObject(includeInstance, f)
  };
...
proto.common.events.EventSubscriptionState.prototype.getStatus = function() {
  return /** @type {!proto.common.events.EventSubscriptionState.STATUS} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
...
/**
 * optional EventMatcher event_matcher = 4;
 * @return {?proto.common.events.EventMatcher}
 */
proto.common.events.EventSubscriptionState.prototype.getEventMatcher = function() {
  return /** @type{?proto.common.events.EventMatcher} */ (
    jspb.Message.getWrapperField(this, proto.common.events.EventMatcher, 4));
};
...
/**
 * optional EventPublication event_publication_spec = 5;
 * @return {?proto.common.events.EventPublication}
 */
proto.common.events.EventSubscriptionState.prototype.getEventPublicationSpec = function() {
  return /** @type{?proto.common.events.EventPublication} */ (
    jspb.Message.getWrapperField(this, proto.common.events.EventPublication, 5));
};
 ...
 * @return {!proto.common.events.EventSubscriptionState} returns this
*/
proto.common.events.EventSubscriptionState.prototype.setEventPublicationSpec = function(value) {
 ...
 * @return {!proto.common.events.EventSubscriptionState} returns this
 */
proto.common.events.EventSubscriptionState.prototype.clearEventPublicationSpec = function() {
 ...
 * @return {boolean}
 */
proto.common.events.EventSubscriptionState.prototype.hasEventPublicationSpec = function() {
