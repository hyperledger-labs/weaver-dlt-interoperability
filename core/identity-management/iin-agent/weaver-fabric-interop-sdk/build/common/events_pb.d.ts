...
export class EventSubscriptionState extends jspb.Message { 
    ...
    getEventPublicationSpec(): EventPublication | undefined;
    setEventPublicationSpec(value?: EventPublication): EventSubscriptionState;
...
export namespace EventSubscriptionState {
    export type AsObject = {
        ...
        message: string,
        eventMatcher?: EventMatcher.AsObject,
        eventPublicationSpec?: EventPublication.AsObject,
    }
