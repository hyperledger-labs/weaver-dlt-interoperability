...
export interface ContainerReflection extends Reflection, S<M.ContainerReflection, "children" | "groups" | "categories" | "sources"> {
}
export interface Reflection extends S<M.Reflection, "id" | "name" | "kind" | "kindString" | "comment"> {
