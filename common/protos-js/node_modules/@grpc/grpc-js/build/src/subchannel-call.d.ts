...
export declare class Http2SubchannelCall implements SubchannelCall {
    ...
    constructor(http2Stream: http2.ClientHttp2Stream, callStatsTracker: SubchannelCallStatsTracker, listener: InterceptingListener, subchannel: Subchannel, callId: number);
