...
class LoadBalancingCall {
    constructor(channel, callConfig, methodName, host, credentials, deadline, filterStackFactory, callNumber) {
        var _a, _b;
    ...
    outputStatus(status, progress) {
        ...
        if (!this.ended) {
            ...
            const finalStatus = Object.assign(Object.assign({}, filteredStatus), { progress });
