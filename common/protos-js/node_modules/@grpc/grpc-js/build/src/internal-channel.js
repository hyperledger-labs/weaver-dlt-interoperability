...
class InternalChannel {
    ...
    createLoadBalancingCall(callConfig, method, host, credentials, deadline) {
        ...
        this.trace('createLoadBalancingCall [' +
            ...
            method +
            '"');
        return new load_balancing_call_1.LoadBalancingCall(this, callConfig, method, host, credentials, deadline, this.filterStackFactory, callNumber);
    }
    ...
    createResolvingCall(method, deadline, host, parentCall, propagateFlags) {
        ...
        const call = new resolving_call_1.ResolvingCall(this, method, finalOptions, this.filterStackFactory, this.credentials._getCallCredentials(), call_number_1.getNextCallNumber());
        if (this.channelzEnabled) {
