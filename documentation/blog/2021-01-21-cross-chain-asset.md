...
author_url: https://pages.github.com/VRamakrishna/weaver-dlt-interoperability/
...
For general-purpose interoperability of enterprise blockchains, we have developed the [Weaver](https://pages.github.com/VRamakrishna/weaver-dlt-interoperability/) tool that incorporates a cross-chain state verification engine to enable cross-chain state sharing and verification. Please check out our documentation for implementation details and example applications.
